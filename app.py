...
AVAILABLE_COMPONENTS = {
    ...
    "Axial Flow Fan": "Axial_flow_fan.png", "Bag Filter/Separator": "Bag.png",
    "Bin/Silo": "Bin.png", "Briquetting Machine": "Briquetting_Machine.png",
    ...
    "Column / Tower": "Column.png", "Combustion Chamber": "Combustion.png",
    ...
    "Hammer Crusher": "Hammer_Crusher.png", "Heater": "Heater.png", "Hose": "Hose.png",
    "Impact Crusher": "Impact_Crusher.png", "Kettle Heat Exchanger": "Kettle_Heat.png",
    "Level Switch (Purge Tank)": "Level switch for liquid purge tank.PNG", "Lift": "Lift.png",
    "Liquid Flushing Assembly": "Liquid flushing assembly.PNG", "Liquid Ring Pump": "Liquid_ring.png",
    "Mixer": "Mixer.png", "Motor": "Motor.PNG", "N2 Purge Assembly": "N2 Purge assembly.PNG",
    "Needle Valve": "Needel_Valve.png", "One-to-Many Splitter": "One-to-Many.png",
    "Open Tank": "Open_tank.png", "Overhead Conveyor": "Overhead.png", "Panel": "Panel.png",
    "Peristaltic Pump": "Peristaltic_pump.png", "Plate Heat Exchanger": "Plate_Heat.png",
    ...
    "Screening Machine": "Screening.png", "Screw Conveyor": "Screw_Conveyor.png",
    ...
    "Silencer": "Silencer.png", "Single Pass Heat Exchanger": "Single_Pass_Heat.png",
    ...
    "Thermometer": "Thermometers.png", "Thin-Film Dryer": "Thin-Film.png",
    "Traced Line": "Traced_Line.png", "U-Tube Heat Exchanger": "U-tube_Heat.png",
    "VFD Panel": "VFD.jpg", "Valves (General Symbol)": "Valves.png",
...
def get_image_as_data_uri(filename):
    ...
    try:
        ...
        mime_type = f"image/{ext}" if ext in ["png", "jpg", "jpeg"] else "application/octet-stream"
...
with col1:
    with st.form("component_form"):
        ...
        # FIX: The Tag is now the unique part
        comp_tag = st.text_input("Component Tag (MUST BE UNIQUE)", f"Comp-{len(st.session_state.component_list) + 1}")
        submitted = st.form_submit_button("Add Component")
        if submitted:
            # Check for duplicate tags
            if any(c['Tag'] == comp_tag for c in st.session_state.component_list):
                st.error(f"Tag '{comp_tag}' already exists. Please use a unique tag.")
            else:
                st.session_state.component_list.append({
                    "Tag": comp_tag, "Symbol_Image": AVAILABLE_COMPONENTS[comp_type], "Description": comp_type
                })
                st.rerun()
    ...
    if not st.session_state.component_list:
        ...
        with st.spinner("Drawing P&ID..."):
            ...
            for component in st.session_state.component_list:
                ...
                # FIX: We use the unique Tag for the node name and the label
                if data_uri:
