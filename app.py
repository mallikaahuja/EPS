...
# Layers
svg_parts.append('<!-- Background Layer -->')
if GRID_VISIBLE:
...
# Drawing border
svg_parts.append('<!-- Drawing Border -->')
...
# Equipment layer
svg_parts.append('<!-- Equipment Layer -->')
...
if ANNOTATIONS_VISIBLE:
    svg_parts.append('<!-- Annotations Layer -->')
